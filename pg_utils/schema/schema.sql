...
BEGIN
        IF new.item_sold=TRUE AND old.item_sold=FALSE THEN
...
CREATE TRIGGER item_sold AFTER UPDATE OF item_sold ON items_for_sale EXECUTE FUNCTION purchase_remove();
